...
📍 Gurugram, India · ✉️ puneetyadav95@gmail.com · [LinkedIn](https://linkedin.com/in/punit-yadav-2ab6a013b)
...
**[▶ Try the live prototype](https://raopunit95.github.io/gmc-decoder/)** · [source](https://github.com/raopunit95/gmc-decoder)
...
A self-built prototype beat waiting for a sprint slot. Cutting a rule engine down to a single
eligibility check saved seven engineering days and lost nothing.
...
📄 [Full resume](./resume.md) · [PDF](./resume.pdf) · 🤖 [profile.json](./profile.json) *(machine-readable)*
